...
{data !== null ? (
    ...
    <iframe
src={(src==='https://multiembed.mov/?video_id=')?`${src}${tvseriesid}&tmdb=1&s=${data.seasons[0].season_number===1?season+1:season}&e=${episode}`:`${src}${tvseriesid}/${data.seasons[0].season_number===1?season+1:season}/${episode}`}
