...
{data !== null ? (
    ...
    <iframe
            src={(src==='https://multiembed.mov/?video_id=')?`${src}${tvseriesid}/${(data !== null && data.seasons[0].season_number!==1)?season:{season+1}}/${episode}`:`${src}${tvseriesid}/${(data !== null && data.seasons[0].season_number!==1)?season:{season+1}}/${episode}`}
